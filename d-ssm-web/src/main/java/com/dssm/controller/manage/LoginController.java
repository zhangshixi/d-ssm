...
import com.dssm.loader.SpringBeanLoader;
...
public class LoginController extends BaseController {
    ...
    private boolean autoLogin() {
        SystemPropertyLoader systemLoader = SpringBeanLoader.getSystemPropertyLoader();
    ...
    private void doRemoveCookie(String cookieName) {
        ConfigPropertyLoader configLoader = SpringBeanLoader.getConfigPropertyLoader();
