	...
	<body>
		...
		<div class="main">
			...
			<div class=" title_row dark_blue">
				<form id="addForm" name="addForm" method="post" action="${ctx}/platform">
					...
					<table width="100%" cellspacing="1" cellpadding="3">
						<tbody>
							...
							<tr>
								...
								<td><input type="text" class="inputBorder" name="enable" /></td>
							</tr>
							<tr>
	        ...
	        $().ready(function() {
	            ...
	            $("#addForm").validate({
	                rules: {
	                    ...
	                    code: {
	                        required: true,
							remote: "${ctx}/platform/check/code"
	                    }
	                },
	                messages: {
	                    name: {
