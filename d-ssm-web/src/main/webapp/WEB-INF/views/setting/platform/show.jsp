	...
	<div class="main">
			<div class="main_title">
				<span class="left bold main_title_top dark_blue">
					<a href="${ctx}/platform">权限管理</a> &gt;&gt; 查看
				</span>
				<span class="right add_t"><a href="${ctx}/platform" title="添加">返回列表</a></span>
			</div>
			
			<div class="clear"></div>
			
			<div class=" title_row dark_blue">
				<form id="editForm" name="editForm" method="post" action="${ctx}/platform/${target.id}">
					...
					<table width="100%" cellspacing="1" cellpadding="3">
						<tbody>
							...
							<tr>
								<td class="label dark_blue">是否支持</td>
								<td><input type="text" class="inputBorder" name="enable" value="${target.enable}" /></td>
							</tr>
							<tr>
