	...
	<body>
		...
		<div class="main">
			<div class="main_title">
				<span class="left bold main_title_top dark_blue">菜单管理</span>
				<span class="right add_t">
					<shiro:hasPermission name="category:new">
						<a href="${ctx}/category/new" title="添加">添加</a>
					</shiro:hasPermission>
				</span>
			</div>
			...
			<div id="searchPanel" class="search_row dark_blue">
				...
				<form id="searchForm" name="searchForm" method="post" action="${ctx}/category/list">
