		...
		<div class="main">
			<div class="main_title">
				<span class="left bold main_title_top dark_blue">
					<a href="${ctx}/transtype">权限管理</a> &gt;&gt; 添加
				</span>
				<span class="right add_t"><a href="${ctx}/transtype" title="添加">返回列表</a></span>
			</div>
			
			<div class="clear"></div>
			
			<div class=" title_row dark_blue">
				<form id="addForm" name="addForm" method="post" action="${ctx}/transtype">
					...
					<table width="100%" cellspacing="1" cellpadding="3">
						<tbody>
							...
							<tr>
								<td class="label dark_blue">事务类型</td>
	        ...
	        $().ready(function() {
	            ...
	            $("#addForm").validate({
	                rules: {
	                    ...
	                    code: {
	                        required: true,
							remote: "${ctx}/transtype/check/code"
	                    }
	                },
	                messages: {
	                    name: {
