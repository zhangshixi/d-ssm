		...
		<div class="main">
			<div class="main_title">
				...
				<span class="right add_t">
					<shiro:hasPermission name="transtype:new">
						<a href="${ctx}/transtype/new" title="添加">添加</a>
					</shiro:hasPermission>
				</span>
			</div>
			...
			<div id="searchPanel" class="search_row dark_blue">
				...
				<form id="searchForm" name="searchForm" method="post" action="${ctx}/transtype/list">
