	...
	<body>
		...
		<div class="main">
			<div class="main_title">
				<span class="left bold main_title_top dark_blue">角色管理</span>
				<span class="right add_t">
					<shiro:hasPermission name="menu:new">
						<a href="${ctx}/menu/new" title="添加">添加</a>
					</shiro:hasPermission>
				</span>
			</div>
			...
			<div id="searchPanel" class="search_row dark_blue">
				...
				<form id="searchForm" name="searchForm" method="post" action="${ctx}/menu/list">
